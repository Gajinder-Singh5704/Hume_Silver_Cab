...
const  SeatDetails = ({data}) =>{
  ...
  const [isLuggageModalOpen , setIsLuggageModalOpen] = useState(data.name == "Maxi Taxi")
  ...
  return (
    <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col justify-between">
      ...
      <div className="flex items-center px-4 py-3 border-b">
        <button className="mr-2 text-lg" aria-label="Back" onClick={handleBackClick}>&lt; Back</button>
      </div>
      {/* Main Content */}
