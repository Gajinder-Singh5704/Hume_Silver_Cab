    ...
    >
      ...
      {showWhatsapp && (
        <a
          ...
          className="w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-xl bg-green-500 hover:scale-110 transition-transform"
        >
          <svg
      ...
      {showCall && (
        <a
          ...
          aria-label="Call us"
          title="Call us"
          className="w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-xl bg-blue-600 hover:scale-110 transition-transform"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
